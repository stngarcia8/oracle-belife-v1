...
namespace BeLife.Modelo.Clases
{
    public class Prima
    {
        ...
        public override string ToString()
        {
            ...
            myBuilder.Append("Recargos aplicados por: ");
            myBuilder.Append("Edad:" + this.calculaRecargoEdad().ToString() + " UF.     |");
            myBuilder.Append("Sexo:" + this.calculaRecargoSexo().ToString() + " UF.     |");
            myBuilder.Append("Estado civil:" + this.calculaRecargoEstadoCivil().ToString() + " UF.");
